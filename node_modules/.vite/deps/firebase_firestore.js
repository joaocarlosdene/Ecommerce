  ...
  start() {
    return this.di().then(() => {
      if (!this.isPrimary && !this.allowTabSynchronization)
        throw new FirestoreError(C2.FAILED_PRECONDITION, Ae);
...
var __PRIVATE_View = class {
  ...
  applyChanges(e, t, n) {
    ...
    const s = t ? this.Ia() : [], o = 0 === this.oa.size && this.current ? 1 : 0, _ = o !== this.sa;
...
async function __PRIVATE_synchronizeQueryViewsAndRaiseSnapshots(e, t, n) {
  ...
  for (const e2 of t) {
    ...
    if (n2 && 0 !== n2.length) {
      ...
      for (const e3 of n2) {
        const t3 = r2.ma.get(e3), n3 = await __PRIVATE_synchronizeViewAndComputeSnapshot(r2, t3);
...
var Transaction$2 = class {
  ...
  async lookup(e) {
    if (this.ensureCommitNotCalled(), this.mutations.length > 0)
      throw new FirestoreError(C2.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
    const t = await async function __PRIVATE_invokeBatchGetDocumentsRpc(e2, t2) {
      ...
      }, s = await n.Co("BatchGetDocuments", r2, i, t2.length), o = /* @__PURE__ */ new Map();
      s.forEach((e3) => {
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  Au(e) {
    ...
    if (__PRIVATE_isWrite(this.Iu) && pe.test(e))
...
var __PRIVATE_TestingHooksSpiImpl = class ___PRIVATE_TestingHooksSpiImpl {
  ...
  static get instance() {
    return be2 || (be2 = new ___PRIVATE_TestingHooksSpiImpl(), function __PRIVATE_setTestingHooksSpi(e) {
      if (le)
